...
export const HeroSection = () => {
  return (
    <section id="game" className="min-h-screen wood-bg flex items-center pt-20 relative overflow-hidden">
      {/* Decorative elements */}
      <div
        className="absolute top-20 left-10 w-16 h-16 leaf leaf-1 opacity-40"
        style={{ transform: 'rotate(-15deg)' }}
      >
      </div>
      <div
        className="absolute bottom-32 right-16 w-20 h-20 leaf leaf-2 opacity-30"
        style={{ transform: 'rotate(10deg)' }}
      >
      </div>
      <div
        className="absolute top-1/3 right-1/4 w-12 h-12 leaf leaf-1 opacity-20"
